//
//  XL HTTPStatusCodes.m
//  MEXPrototype
//
//  Created by DX089 on 12-08-10.
//  Copyright (c) 2012 Xtreme Labs. All rights reserved.
//
...
@implementation XLHTTPStatusCodes


+ (NSString*)stringForStatusCode:(int)code 
{
    ...
    switch (code) {  
        ...
        case 205: return @"201:Reset Content";                  break;
        ...
        default:
            return [NSString stringWithFormat:@"%d:Unknown status code",code];
            break;
    }
...
//                                269 Call Back Later
//                                The server has received the request and needs time to process it asynchronously. The client should make a corresponding GET request again later. The server may specify this URI and callback timestamp with the X-Callback-At and X-Callback-In headers, respectively.
...
//                                                            Nginx internal code simular to 431 but it was introduced earlier.[23]
...
//                                                                    Transparent content negotiation for the request results in a circular reference.[25]
